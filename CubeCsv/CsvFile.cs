...
namespace CubeCsv
{
    ...
    {
        private readonly CsvStreamReader _csvStreamReader;
        private readonly CsvSqlWriter _csvSqlWriter;
        private readonly CsvSqlReader _csvSqlReader;
        ...
        public CsvFile(string table, DbConnection connection, CsvFile csvFile, CsvConfiguration configuration)
        {
            _csvSqlWriter = new CsvSqlWriter(table, connection, csvFile, configuration);
